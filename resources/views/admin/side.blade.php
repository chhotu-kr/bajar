<div class="list-group">
    ...
    <a href="{{route('user.index')}}" class="list-group-item list-group-item-action">Manage User</a>
    ...
    <a href="{{route('payment.index')}}" class="list-group-item list-group-item-action">Manage Payments</a>
